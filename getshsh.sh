...
if [ $# != 5 ]; then
    ...
    echo "ex: ./getshsh.sh 11.3.1 iPhone6,1 n51ap 0x12345678 shsh"
    exit
else
    ...
    ## Stopper ##
    echo "ApNonce: 7d7bdc28e5eca36dc5bc20c791850f110dc28269"
    ./tsschecker -i $1 —d $2 --boardconfig $3 -e $4 --save-path $5 -s --apnonce 7d7bdc28e5eca36dc5bc20c791850f110dc28269
